...
<head>
    ...
    <link href="/temp/vendors/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
...
<body  class="m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--offcanvas-default m-aside-left--enabled m-aside-left--fixed m-aside-left--skin-dark m-aside--offcanvas-default"  >
                        ...
                        <div class="m-stack m-stack--ver m-stack--general">
                            <div class="m-stack__item m-stack__item--middle m-brand__logo">
                                <a href="/" class="m-brand__logo-wrapper">
                                    <img alt="" src="/temp/media/img/logo/icon.png" style="max-width:45px" />
                                </a>
                            </div>
                ...
                <div class="m-stack m-stack--flex-tablet-and-mobile m-stack--ver m-stack--desktop">
                    <div class="m-stack__item m-stack__item--left m-stack__item--middle m-stack__item--last">
                        <span class="m-footer__copyright">
                            <?=date('Y')?> <img alt="" src="/temp/media/img/logo/logo_bni_72x23.png" style="max-height:10px;margin:0px 3px 2px 3px;" />
                            <a href="http://bni.co.id/" target="blank" class="m-link">
    ...
    <!-- <script src="/temp/vendors/custom/flot/flot.bundle.js" type="text/javascript"></script> -->
    <script src="/temp/vendors/custom/fullcalendar/fullcalendar.bundle.js" type="text/javascript"></script>

    <!-- amchart assets -->
    <script src="/temp/vendors/custom/amchart/core.js" type="text/javascript"></script>
    <script src="/temp/vendors/custom/amchart/charts.js" type="text/javascript"></script>
    <script src="/temp/vendors/custom/amchart/themes/animated.js" type="text/javascript"></script>

    <!-- <script src="/temp/app/js/dashboard.js" type="text/javascript"></script> -->
    <?php $this->endBody()?>
</body>
</html>
<?php $this->endPage()?>
